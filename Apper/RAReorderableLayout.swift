...
//        let insetEnd = self.insetsEnd
    ...
    private func moveItemIfNeeded() {
        ...
        let distCell: UICollectionViewCell? = self.collectionView?.cellForItemAtIndexPath(toIndexPath!)
        let iconData = (distCell as! ItemCollectionViewCell).iconData
        
        // don't move forword if icon is "Add"
...
//        let paddingTop = self.trigerPaddingTop
    ...
    internal func handleLongPress(longPress: UILongPressGestureRecognizer!) {
        ...
        let iconData = (currentCell as! ItemCollectionViewCell).iconData
