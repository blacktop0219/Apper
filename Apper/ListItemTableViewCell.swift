...
//  Apper
//
//  Created by jian on 8/31/15.
//  Copyright © 2015 jinhu. All rights reserved.
//

import UIKit

@objc protocol ListItemTableViewCellDelegate
{
    optional func deleteIcon(index: Int)
    optional func selectedListIcon(index: Int, cell: ListItemTableViewCell)
}
...
class ListItemTableViewCell: UITableViewCell {
    ...
    func actionSelect()
    {
        delegate?.selectedListIcon!(self.tag, cell: self)
    }
}
